...
All that tech stuff aside, I'm excited to have the opportunity to attend the first day of the Workshop (I have other commitments for the the other two days. which I am actually happy for as they are paying my fare across the country).  In particular, I want to explore the use of <a href="http://xrisoft.org/">barx</a> to support alternate XRI/i-name roots so that federations of running proxy resolvers can be upgraded on the fly to include new local roots, simply by distributing a new plugin.  The value of this to the many grass-roots organizations I work with at <a href="http://www.civicactions.com/">CivicActions</a> can't be over stated.
